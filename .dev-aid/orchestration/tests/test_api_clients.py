...
class TestAnthropicClient:
    ...
    def test_init(self, mock_api_key, mock_model_config):
    ...
    def test_cost_calculation_small_amounts(self, mock_api_key, mock_model_config):
    ...
    def test_cost_calculation_zero_tokens(self, mock_api_key, mock_model_config):

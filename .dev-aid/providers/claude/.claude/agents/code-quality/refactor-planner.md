...
activation: |
  - "help me plan a refactoring for [component/module]"
  - "I need to restructure [code area], create a refactoring plan"
  - "analyze this codebase and suggest refactoring improvements"
tools: [Read, Write, Edit, Bash, Grep, Glob]
model: claude-sonnet-4-5
expertise: [software-architecture, code-quality, refactoring, technical-debt]
color: "#9333EA"
category: code-quality
related_skills: [code-architecture-reviewer, test-engineer, documentation-architect, performance-tuner]
author:

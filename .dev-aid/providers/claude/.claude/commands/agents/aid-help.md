...
| `aid-lessons` | `dev-aid-agent-lessons` | Manage agent failure lessons (list/add/resolve/clear) |
| `aid-dod` | `dev-aid-agent-dod-gate` | Verify agent output meets Definition of Done |

**CLI (for scripts/CI):** `dev-aid-agent <agent> [options] --json --dry-run --trace --dod`

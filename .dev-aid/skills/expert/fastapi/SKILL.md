...
- Common attack vectors: Path traversal, BOLA, ReDoS
...
**Step 2: Known Vulnerabilities (2024-2025)**
   ...
   - **CVE-2024-47874** (CVSS 8.7): Starlette path traversal
     Source: https://github.com/encode/starlette/security/
   - **OWASP-API-2023-01** (CVSS N/A): BOLA attacks
     Source: https://owasp.org/API-Security/
   - **CVE-2024-24762** (CVSS 7.5): Pydantic ReDoS

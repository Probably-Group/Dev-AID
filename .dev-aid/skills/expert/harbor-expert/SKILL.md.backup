...
- **Performance Optimization**: `references/performance-optimization.md` - Garbage collection, replication, caching, storage, database tuning
- **Anti-Patterns**: `references/anti-patterns.md` - Common mistakes and how to avoid them
- **Testing Guide**: `references/testing-guide.md` - Unit, integration, and E2E testing for Harbor
